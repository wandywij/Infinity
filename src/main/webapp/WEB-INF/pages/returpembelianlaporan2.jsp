    ...
    <div class="col-xs-12">
        <table>
            <tr>
                ...
                <td >
                    <button type="submit" id="btnEdit" class="pull-right btn btn-success">Edit</button>
                </td>
            </tr>
        </table>
    </div>
...
<!--            <div class="form-group">
            ...
            <table class="pull-right">
                ...
                <tr >
                    <td>Nomor Faktur</td>
                    <td> : </td>
                    <td>${dataEdit.no_faktur} 
                    <input type="hidden" id="txtNoFaktur" value="${dataEdit.no_po}"></input>
                    </td>
                ...
                <tr>
                    <td>Tanggal</td>
                    <td> : </td>
                    <td>${dataEdit.tanggal}</td>
                </tr>
                <tr>
                    <td>Supplier</td>
                    <td> : </td>
                    <td>${dataEdit.supplier}</td>
                </tr>
                <tr>
                    
                    <td>Pegawai</td>
                    <td> : </td>
                    <td>${dataEdit.pelanggan}</td>
                </tr>
            </table>
...
<script>
    ...
    $('#btnEdit').click(function(){
        window.location.href='${baseURL}retur-pembelian/po/' + 
                $("#txtNoFaktur").val();
    });
</script>
