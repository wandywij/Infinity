...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                <label for="pelanggan" class="col-xs-2 control-label">Supplier</label>
                <div class="col-xs-10">
			...
			<tbody id="tbodyitem">
                        ...
                        <c:forEach items="${dataEdit.detailData}" var="data1">
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="jumlah" style="text-align: right;" value="${data1.jumlah}"/></td>
                        ...
                        <c:if test="${empty isDetail}">
                            <tr>
                                ...
                                <td><input type="text" class="form-control jumlah" name="jumlah" style="text-align: right;"/></td>
