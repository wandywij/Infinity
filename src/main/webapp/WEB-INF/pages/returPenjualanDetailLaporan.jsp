...
<!--<table class="table table-bordered">
    <tr>
        ...
        <td> <label id="no_retur_penjualan" name="no_retur_penjualan" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.no_returpenjualan}</c:if></label></td>
    </tr>
</table>-->
...
<!--				<div class="col-xs-10">
                                ...
                                <div class="col-xs-2 control-label">
                                    <label id="no_retur_penjualan" name="no_retur_penjualan" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.no_returpenjualan}</c:if></label>
				</div>
			</div>
			<div class="form-group">
...
<!--				<div class="col-xs-10">
					<p><input type="text" class="form-control" id="tanggal" name="tanggal" style="width:130px" placeholder="Tanggal"<c:if test="${!empty dataEdit}"> value="${dataEdit.tanggal}"</c:if>></p>
                                ...
                                <div class="col-xs-2 control-label">
                                    <label id="tanggal" name="tanggal" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.tanggal}</c:if></label>
				</div>
			</div>
			<div class="form-group">
				<label for="alamat" class="col-xs-2 control-label">No. Faktur penjualan</label>
				<div class="col-xs-2 control-label">
                                    <label id="no_faktur" name="no_faktur" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.no_faktur}</c:if></label>
				</div>
			</div>
                        <div class="form-group">
				<label for="alamat" class="col-xs-2 control-label">Pegawai</label>
				<div class="col-xs-2 control-label">
                                    <label id="pegawai" name="pegawai" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.pegawai}</c:if></label>
				</div>
			</div>
                        <div class="form-group">
				<label for="alamat" class="col-xs-2 control-label">Pelanggan</label>
				<div class="col-xs-2 control-label">
                                    <label text-align="left" id="pelanggan" name="pelanggan" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.pelanggan}</c:if></label>
				</div>
			</div>
                        <div class="form-group">
				<label for="alamat" class="col-xs-2 control-label">Kode Barang</label>
				<div class="col-xs-2 control-label">
                                    <label id="kode_barang" name="kode_barang" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.kode_barang}</c:if></label>
				</div>
			</div>
                        <div class="form-group">
...
<!--                                    <input type="text" class="form-control" name="nama_barang" id="nama_barang" placeholder="Nama Barang"<c:if test="${!empty dataEdit}"> value="${dataEdit.nama_barang}"</c:if>>-->
                                    <label id="nama_barang" name="nama_barang" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.nama_barang}</c:if></label>
                                </div>
			</div>
                        <div class="form-group">
...
<!--                                    <p><input type="text" class="form-control text-right numberfilter" id="jumlah" name="jumlah" style="width:130px" <c:if test="${!empty dataEdit}"> value="${dataEdit.jumlah}"</c:if><c:if test="${empty dataEdit}"> value="0"</c:if>></p>-->
                                    <label text-align="left" id="nama_barang" name="nama_barang" rows="1"><c:if test="${!empty dataEdit}">${dataEdit.jumlah}</c:if></label>
                                </div>
			</div>
