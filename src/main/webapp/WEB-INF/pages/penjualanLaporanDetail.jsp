            ...
            <tbody>
                <c:forEach items="${dataList}" var="data1">
                    <tr>
                        ...
                        <td class="text-right"><c:out value="${data1.jumlah}"/></td>
                        <td class="numberfilter text-right"><c:out value="${data1.diskon}"/></td>
                        <td class="numberfilter text-right"><c:out value="${data1.harga}"/></td>
